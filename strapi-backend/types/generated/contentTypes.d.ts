...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0110\u1EB7t tour t\u1EEB website';
    displayName: 'Booking';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    tourDate: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiChatMessageChatMessage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tin nh\u1EAFn t\u1EEB chatbox h\u1ED7 tr\u1EE3 tr\u1EF1c tuy\u1EBFn';
  ...
  attributes: {
    ...
    sessionToken: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Li\u00EAn h\u1EC7 t\u1EEB website';
    displayName: 'Contact';
    pluralName: 'contacts';
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0110i\u1EC3m \u0111\u1EBFn du l\u1ECBch Vi\u1EC7t Nam';
  ...
  attributes: {
    ...
    spots: Schema.Attribute.Component<'destination-details.spot', true>;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    difficulty: Schema.Attribute.Enumeration<
      ['D\u1EC5', 'Trung b\u00ECnh', 'Kh\u00F3']
    > &
      Schema.Attribute.DefaultTo<'D\u1EC5'>;
    duration: Schema.Attribute.String;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    image: Schema.Attribute.Media<'images'>;
    images: Schema.Attribute.Media<'images', true>;
    itinerary: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tour.tour'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    mapUrl: Schema.Attribute.String;
    maxGroupSize: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<20>;
